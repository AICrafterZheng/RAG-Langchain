...
from query_data import get_basic_qa_chain, get_custom_prompt_qa_chain
...
class ChatWrapper:
    def __init__(self):
        ...
        # self.chain = set_openai_api_key(self.api_key)
        self.lock = Lock()
...
with block:
    ...
    message.submit(chat, inputs=[openai_api_key_textbox,
